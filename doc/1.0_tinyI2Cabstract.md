...
<!-- Table: 該当するI^2^Cバスの動き

`doc/Out/commandSandP_wo_bus.tmd`{.include} -->

<!-- ![該当するI^2^Cバスの動き](doc/images/commandSandP_wo_bus.png) -->
![該当するI^2^Cバスの動き](images/commandSandP_wo_bus.eps)
